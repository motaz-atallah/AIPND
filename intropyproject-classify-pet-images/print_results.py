...
#             f unction and results for the function call within main.
...
def print_results(results_dic, results_stats_dic, model,
    ...
    Parameters:
        ...
        results_stats_dic - Dictionary that contains the results statistics (either
                   a  percentage or a count) where the key is the statistic's
                     ...
                     and the value is the statistic's value  (dict)
    ...
    if (print_incorrect_dogs and
            results_stats_dic[StatFields.N_CORRECT_DOGS.value] + results_stats_dic[StatFields.N_CORRECT_NOTDOGS.value]
            != results_stats_dic[StatFields.N_IMAGES.value]):
        print_misclassified_items(results_dic, misclassified_dogs_condition, "\n** Misclassified Dogs: ")

    # Print misclassified breeds if requested
    if (print_incorrect_breed and
            results_stats_dic[StatFields.N_CORRECT_DOGS.value] != results_stats_dic[StatFields.N_CORRECT_BREED.value]):
...
def print_summary(results_stats_dic, model):
    ...
    Parameters:
        results_stats_dic - Dictionary containing statistics on the results (dict)
